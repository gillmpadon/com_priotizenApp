...
<body>
    <div class="container">
        ...
        <div class="buttonNav">
            <button class="active"onclick="goPage('verify')">SENIOR</button>
            <button class="notActive" onclick="goPage('unverify')">PWD</button>
        </div>
        </div>
