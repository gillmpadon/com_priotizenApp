...
$query = "select r.price, r.discount, r.img_receipt as receipt, v.lname, n.status, DATE(r.date) as date  from receipt r inner join verified v on r.user_id = v.id inner join notification n on r.receipt_id = n.reciept_id where  n.status !='Completed'";
...
<body>
    <div class="container">
        ...
        <div class="notifications">
            ...
            if( mysqli_num_rows($result)>0){
                ...
                <div class="info">
                    ...
                    <button class="paynow" id="paynowBtn"><?php echo $status; ?></button>
                </div>
            </div>
            <?php
                }}
        ...
        <div class="buttonNav">
            <button class="active" onclick="goPage('entry')">ENTRY</button>
            <button class="notActive"onclick="goPage('history')">HISTORY</button>
        </div>
