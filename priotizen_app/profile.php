    ...
    <div class="container">
        ...
        <div class="dashboard">
            <div class="entry" onclick="goPage('profile_info')">
                ...
                <p>Profile</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 512 512"><path fill="none" stroke="black" stroke-linecap="square" stroke-miterlimit="10" stroke-width="48" d="m184 112l144 144l-144 144"/></svg>
            </div>
            ...
            <div class="entry notFill" onclick="goPage('card_front')">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 48 48"><g fill="black" stroke="black" stroke-linejoin="round" stroke-width="4"><path d="M42 8H6a2 2 0 0 0-2 2v28a2 2 0 0 0 2 2h36a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2Z"/><path d="M36 16h-8v8h8v-8Z"/><path stroke-linecap="round" d="M12 32h24M12 16h6m-6 8h6"/></g></svg>
                <p>ID Information</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 512 512"><path fill="none" stroke="black" stroke-linecap="square" stroke-miterlimit="10" stroke-width="48" d="m184 112l144 144l-144 144"/></svg>
            </div>
