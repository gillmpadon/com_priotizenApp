...
<script>
 ...
 function sendRequest(e, brgy, condition){
 ...
 brgy.addEventListener('change', function(e) {
    const searchVal = (search.value)!=""? search.value:""
    const conditionVal = (condition.value)!=""? condition.value: ""
    const brgyVal = (brgy.value)!=""? brgy.value: ""
    sendRequest(searchVal,brgy.value,conditionVal)
 })
 condition.addEventListener('change', function(e) {
    const searchVal = (search.value)!=""? search.value:""
    const brgyVal = (brgy.value)!=""? brgy.value: ""
    const conditionVal = (condition.value)!=""? condition.value: ""
    sendRequest(searchVal, brgyVal, conditionVal)
 })
